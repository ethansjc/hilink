...
const Guide = () => {
  return (
    <section className="flexCenter flex-col">
      <div className=" paddung-container max-container w-full pb-24">
        <Image src="/camp.svg" alt="camp" width={50} height={50} />
        <p className='uppercase regular-18 -mt-1'>
          We are here for you
        </p>
        <div className="flex flex-wrap justify-between gap-5 lg:gap-10">
          <h2 className='bold-40 lg:bold-64 xl:max-w-[390px]'>Guide You to Easy Path</h2>
          <p className='regular-16 text-gray-30 xl:max-w-[520px]'>Only with the hilink application you will no longer get
        ...
        border shadow-md md:left-[5%] lg:top-20">
          ...
          <div className="flexBetween flex-col">
            <div className="flex w-full flex-col">
              ...
              <p className="bold-20 mt-2">Aguas Gendo</p>
            </div>

          <div className="flex w-full flex-col">
                <p className="regular-16 text-gray-20">Start track</p>            
              <p className="bold-20 mt-2 whitespace-nowrap">Wonorejo Pasuraun</p>
            </div>
          </div>
